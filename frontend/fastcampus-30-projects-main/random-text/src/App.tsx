...
function App() {
		...
		return (
			<>
				<Flex position={"fixed"} right={["16px","64px","64px"]} top={["16px","64px","64px"]}>
					<Flex bg="#2699FB" width={"48px"} height="48px" borderRadius={"4px"}
				...
				<Flex flexDirection={"column"}
					...
					<Flex
						...
						width="100%"
						alignItems={"center"} justifyContent="center" maxWidth={"1000px"} height={"160px"} fontSize={"48px"}>
	...
	return <Flex pt={["8px","64px","64px"]} pl={["8px","64px","64px"]} flexDirection={"column"}>
		<Flex
			pb="44px"
			style={{
				gap: "44px"
		...
		{
			dataList?.map((data, idx) => <Flex width={["90%","416px","416px"]} height={"48px"} mb="16px" key={data.message}>
				...
				<Flex bg="#FF0C0C" width={"48px"} height="48px" borderRadius={"4px"}
					alignItems="center" justifyContent={"center"}
					onClick={() => {
