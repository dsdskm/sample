...
public class LV2CodingTest_StackQueue2_Solution {
    ...
    public static void main(String args[]) {
        new LV2CodingTest_StackQueue2_Solution().solution(new int[]{93, 30, 55}, new int[]{1, 30, 5});
        new LV2CodingTest_StackQueue2_Solution().solution(new int[]{95, 90, 99, 99, 80, 99}, new int[]{1, 1, 1, 1, 1, 1});
    }
